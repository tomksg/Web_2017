...
<ul>
 <li class="iist_image"><a href="list.php?categrory=1"><img src="img/lnav_1.png" alt="..." ></a></li>
 <li class="iist_image"><a  href="list.php?categrory=2"><img src="img/lnav_2.png" alt="..." class=""></a></li>
 <li class="iist_image"><a href="list.php?categrory=3"><img src="img/lnav_3.png" alt="..." class=""></a></li>
  <li class="iist_image"><a href="list.php?categrory=4"><img src="img/lnav_4.png" alt="..." class=""></a></li>
</ul>
&nbsp;
<!-- 근데 창줄이면 깨지네 ;; -->
<br>
